...
event_meta_path = sys.argv[2]



flag_raw=sys.argv[3]

with open(event_meta_path, 'r') as md_f:
    event = json.load(md_f)
...
file_hash, _ = os.path.splitext(os.path.basename(event_meta_path))
